...
class Paginator(tk.Frame):
    ...
    def __init__(self, master, displayed_pages, total_pages, background=None, current_page=None, start_page=1,
                 prev_button="Prev", next_button="Next",
                 first_button="First", last_button="Last", hide_controls_at_edge=False, command=None,
    ...
    def _render_pagination(self, current_page, prev_button, next_button, first_button, last_button, displayed_pages,
        ...
        for page_number in range(start_page, start_page + displayed_pages):
            ...
            if page_number <= end_page:
                page_label = Page_Label(self._page_frame, page_number, self._style_config, self._on_click_page,
...
if __name__ == "__main__":
    ...
    pagination = Paginator(row, 5, 0, command=print_page, pagination_style=pagination_style3)
    pagination.pack(pady=10, anchor=W)
